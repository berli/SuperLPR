...
#### [![1](https://badge.fury.io/py/SuperLPR.svg "title")](https://pypi.org/project/SuperLPR/)[![1](https://img.shields.io/pypi/pyversions/SuperLPR.svg "title")](https://pypi.org/project/SuperLPR/)

### 一键安装

`pip install SuperLPR`
...
```python
#导入包
from SuperLPR import *
#导入OpenCV库
import cv2
#读入图片
image = cv2.imread("demo.jpg")
#识别结果
print(SuperLPR_PlateRecogntion(image))
```
...
- [端到端(多标签分类)训练代码](https://github.com/LCorleone/SuperLPR-train_e2e)(感谢群内小伙伴的工作)。
- [端到端(CTC)训练代码](https://github.com/armaab/SuperLPR-train)(感谢群内小伙伴工作)。
...
- [增加PHP车牌识别工程@coleflowers](https://github.com/zeusees/SuperLPR/tree/master/Prj-PHP) (2018.06.20)
- 添加的新的Python 序列模型-识别率大幅提高(尤其汉字)(2018.3.12)
- 添加了SuperLPR Lite 仅仅需160 行代码即可实现车牌识别(2018.3.12)
...
- 增加字符分割[训练代码和字符分割介绍](https://github.com/zeusees/SuperLPR-Training)(2018.1.)
...
- 体验 Android APP：[https://fir.im/SuperLPR](https://fir.im/SuperLPR) (根据图片尺寸调整程序中的尺度，提高准确率)
- 感谢 sundyCoder [Android 字符分割版本](https://github.com/sundyCoder/SuperLPR4Android) 

### 数据分享

车牌识别框架开发时使用的数据并不是很多，有意着可以为我们提供相关车牌数据。联系邮箱 16645709@qq.com。

#### 获取帮助

- SuperLPR讨论QQ群: 469331966 ,加前请备注SuperLPR交流。
